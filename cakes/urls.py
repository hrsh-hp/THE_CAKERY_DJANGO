...
from cakes.views import get_home_cake_details,get_full_cake_details,like_cake,get_liked_cake_details,add_to_cart,get_cart_details,remove_cart_item,place_order,get_order_details
